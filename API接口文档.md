...
> v1.0 · 2026-06-22 ｜ 基于后端开发文档 v1.13
...
| 方法 | 路径 | 说明 | 参数 |
|------|------|------|------|
| GET | `/api/v1/plot/list` | 烟田列表 | `pageNum, pageSize, plotName?, status?` |
...
| POST | `/api/v1/image/mobile` | 上传手机图片 | Body: `{ plotId, imageUrl, thumbnailUrl, uploadUserId }` |
| DELETE | `/api/v1/image/mobile/{id}` | 删除手机图片 | |
